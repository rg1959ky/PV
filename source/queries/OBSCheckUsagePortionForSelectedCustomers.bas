Operation =1
Option =0
Where ="(((OBSCheckCustomerSelection.[Select])=True))"
Begin InputTables
...
End
Begin Joins
    LeftTable ="OBSCheckCustomerSelection"
    RightTable ="UsagePortionByCustLast365D"
    Expression ="OBSCheckCustomerSelection.Customer = UsagePortionByCustLast365D.Customer"
    Flag =1
End
Begin Groups
    Expression ="UsagePortionByCustLast365D.Item"
