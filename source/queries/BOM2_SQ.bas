Operation =1
Option =0
Where ="(((PN.PNPartNumber) Not Like \"*-DEV\" And (PN.PNPartNumber) Not Like \"*-COM\")"
    " AND ((PN_1.PNPartNumber) Not Like \"AW*\") AND ((PN_1.PNTitle) Not Like \"DWG*\""
    ") AND ((PN_1.PNType)=\"PS\" Or (PN_1.PNType)=\"PL\") AND ((PN.PNExpandList)=Yes)"
    ")"
Begin InputTables
    Name ="PN"
    Name ="PL"
