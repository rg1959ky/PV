...
Begin InputTables
    ...
    Name ="OBSCheckUsagePortionForSelectedCustomers"
End
Begin OutputColumns
    ...
    Alias ="Uniq_Cust"
    Expression ="[OBSCheckUsagePortionForSelectedCustomers]![SumOfCustPortion]"
...
Begin Joins
    ...
    Flag =1
    LeftTable ="KYandPNVBOMs"
    RightTable ="OBSCheckUsagePortionForSelectedCustomers"
    Expression ="KYandPNVBOMs.Child = OBSCheckUsagePortionForSelectedCustomers.Item"
    Flag =1
End
Begin OrderBy
    Expression ="KYandPNVBOMs.Child"
