...
Where ="(((DGReviewInventoryTable.OBS) Is Null Or (DGReviewInventoryTable.OBS)=False) AN"
    "D ((tblTempCompareERPBOMtoEngineeringBOM.[Eng Component])<>\"Note\" Or (tblTempC"
    "ompareERPBOMtoEngineeringBOM.[Eng Component]) Is Null))"
Begin InputTables
...
dbMemo "Filter" ="([ViewtblTempCompareERPBOMtoEngBOM].[Parent] Like \"dc00-240*\")"
Begin
    Begin
