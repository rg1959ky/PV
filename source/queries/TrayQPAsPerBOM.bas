Operation =1
Option =0
Where ="(((BOMLinesThree.[Sub Item]) Like \"*\") AND ((KYandPNVBOMs.Child) Like \"*\") A"
    "ND ((KYandPNVBOMs.[Child Descrip]) Like \"*top/btm*\"))"
Begin InputTables
    Name ="BOMLinesThree"
    Name ="KYandPNVBOMs"
End
...
Begin Joins
    ...
    LeftTable ="BOMLinesThree"
    RightTable ="KYandPNVBOMs"
    Expression ="BOMLinesThree.[Sub Item] = KYandPNVBOMs.Child"
    Flag =1
End
Begin OrderBy
    Expression ="Trim$(BOMLinesThree![Parent Item])"
