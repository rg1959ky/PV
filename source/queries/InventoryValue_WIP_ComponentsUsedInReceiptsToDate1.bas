...
Begin OutputColumns
    ...
    Alias ="SumOfQtyUsedInReceiptsToDate"
    Expression ="Sum(InventoryValue_WIP_ComponentsUsedInReceiptsToDate0.QtyUsedInReceiptsToDate)"
...
Begin
    ...
    End
    Begin
        dbText "Name" ="SumOfQtyUsedInReceiptsToDate"
        dbLong "AggregateType" ="-1"
    End
    Begin
