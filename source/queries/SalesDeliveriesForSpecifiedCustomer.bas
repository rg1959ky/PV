...
Option =0
Begin InputTables
    Name ="ItemListForSpecifiedCustomer"
...
Begin OutputColumns
    ...
    Alias ="LT"
    Expression ="[Delivery Date]-[Order Entry Date]"
    Alias ="Days After PDD"
    Expression ="[Delivery Date]-[Plan Delivery Date]"
End
Begin Joins
    ...
    Flag =1
    LeftTable ="ItemListForSpecifiedCustomer"
    RightTable ="SalesDeliveryLines"
    Expression ="ItemListForSpecifiedCustomer.Part_Number = SalesDeliveryLines.Item"
    Flag =1
End
Begin OrderBy
    Expression ="SalesDeliveryLines.Item"
