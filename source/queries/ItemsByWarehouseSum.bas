Operation =1
Option =0
Where ="(((WarehousesToIncludeInInventorySum.Include)=Yes))"
Begin InputTables
...
End
Begin Joins
    LeftTable ="WarehousesToIncludeInInventorySum"
    RightTable ="ItemsbyWarehouse"
    Expression ="WarehousesToIncludeInInventorySum.Warehouse = ItemsbyWarehouse.Warehouse"
    Flag =1
End
Begin Groups
    Expression ="ItemsbyWarehouse.Item"
