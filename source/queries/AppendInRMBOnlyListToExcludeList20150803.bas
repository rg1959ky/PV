...
Option =0
Where ="(((AfterChangeZZPartNumberChanges_DeleteMe.CommentEN) Like \"In RMB only*\"))"
Begin InputTables
...
Begin OutputColumns
    ...
    Alias ="Comment"
    Name ="Comment"
    Expression ="'In RMB only , and will be RMB in the future, too. No ZZ. (Yvonne 20150622)'"
    Alias ="Expr1"
    Name ="DateAdded"
    Expression ="Now()"
End
