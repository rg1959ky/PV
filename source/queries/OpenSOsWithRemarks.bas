...
Begin OutputColumns
    ...
    Expression ="SOHeaders.INVOICERemark"
    Expression ="SOHeaders.[PACKING-LISTRemark]"
    Expression ="SOHeaders.[Remark 1]"
    Expression ="SOHeaders.[Remark 2]"
    Expression ="SOHeaders.[Remark 3]"
    Expression ="SOHeaders.[Remark 4]"
...
Begin
    ...
    End
    Begin
        dbText "Name" ="SOHeaders.[Remark 3]"
        dbLong "AggregateType" ="-1"
    End
    Begin
    ...
    End
    Begin
        dbText "Name" ="SOHeaders.[Remark 4]"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="SOHeaders.INVOICERemark"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="SOHeaders.[PACKING-LISTRemark]"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="SOHeaders.[Remark 1]"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="SOHeaders.[Remark 2]"
        dbLong "AggregateType" ="-1"
    End
    Begin
