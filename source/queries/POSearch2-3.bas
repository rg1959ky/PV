Operation =1
Option =0
Where ="((([POLinesUnion2-3].Item) Like [Item begins with?] & \"*\"))"
Begin InputTables
...
Begin
    ...
    End
    Begin
        dbText "Name" ="[POLinesUnion2-3].[Item Description]"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="[POLinesUnion2-3].[Purchase Order Type]"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="[POLinesUnion2-3].[Purchase Order No]"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="[POLinesUnion2-3].Sequence"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="[POLinesUnion2-3].[Purchase Quantity]"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="[POLinesUnion2-3].[Purchase Price]"
        dbLong "AggregateType" ="-1"
    End
    Begin
    ...
    End
    Begin
        dbText "Name" ="[POLinesUnion2-3].[Plan Delivery Date]"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="[POLinesUnion2-3].Close"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="[POHeadersUnion2-3].[Tax Type]"
        dbLong "AggregateType" ="-1"
    End
    Begin
    ...
    End
    Begin
        dbText "Name" ="[POLinesUnion2-3].Unit"
        dbLong "AggregateType" ="-1"
    End
End
Begin
