Operation =1
Option =0
Where ="(((SalesDeliveryLines.Item) Like \"7912042*\" Or (SalesDeliveryLines.Item) Like "
    "\"7912043*\" Or (SalesDeliveryLines.Item) Like \"7908012*\" Or (SalesDeliveryLin"
    "es.Item) Like \"7910049*\" Or (SalesDeliveryLines.Item) Like \"7915036*\" Or (Sa"
    "lesDeliveryLines.Item) Like \"7915037*\" Or (SalesDeliveryLines.Item) Like \"791"
    "0055*\"))"
Begin InputTables
