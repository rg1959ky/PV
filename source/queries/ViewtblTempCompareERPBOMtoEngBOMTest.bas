Operation =1
Option =0
Where ="(((IIf(IsNull(EarliestPlanShipDates![MinOfPlan Delivery Date]),\"99999999\",Earl"
    "iestPlanShipDates![MinOfPlan Delivery Date]))<>\"99999999\") And ((tblTempCompar"
    "eERPBOMtoEngineeringBOM.Ratio)>=Forms!frmViewCompareERPBOMtoEngBOM!Text2))"
Begin InputTables
