...
Begin OutputColumns
    ...
    Expression ="dbo_SalesInvoiceEntityView.CreatedByDocumentID"
    Alias ="DeliveryDate"
...
Begin
    ...
    End
    Begin
        dbText "Name" ="dbo_SalesOrderEntityView.ReferenceNumber"
        dbLong "AggregateType" ="-1"
    End
    Begin
        dbText "Name" ="dbo_SalesOrderEntityView.FinancialDateTime"
        dbLong "AggregateType" ="-1"
    End
    Begin
