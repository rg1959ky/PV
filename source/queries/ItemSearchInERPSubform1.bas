dbMemo "SQL" ="SELECT Items.Item, Items.[Item Description], tblItemDescripsFromKYandSLDCUnique."
    ...
    "tandardCost, tblLatestStandardCosts.Currency\015\012FROM (Items LEFT JOIN tblIte"
    "mDescripsFromKYandSLDCUnique ON Items.Item = tblItemDescripsFromKYandSLDCUnique."
    "Part_Number) LEFT JOIN tblLatestStandardCosts ON Items.Item = tblLatestStandardC"
    "osts.Item\015\012WHERE (((Items.Item) Like Forms!frmInventoryInquiry!txtPartNumb"
    "erBegins & \"*\") And ((tblItemDescripsFromKYandSLDCUnique.FirstOfDescrip) Like "
    "\"*\" & Forms!frmInventoryInquiry!EngDescFilter & \"*\" Or (tblItemDescripsFromK"
    "YandSLDCUnique.FirstOfDescrip) Is Null))\015\012ORDER BY Items.Item;\015\012"
dbMemo "Connect" =""
