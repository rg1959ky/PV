...
Option =0
Where ="(((PN.PNPartNumber) Like \"DC08-112-22\") AND ((PN_1.PNType)=\"PS\" Or (PN_1.PNT"
    "ype)=\"PL\") AND ((PN.PNDetail) Is Null)) OR (((PN.PNPartNumber) Like \"DC08-112"
    "-22\") AND ((PN_1.PNType)=\"PS\" Or (PN_1.PNType)=\"PL\") AND ((PN.PNDetail) Not"
    " Like \"*NOT RELEASED*\"))"
Begin InputTables
    Name ="tblCabList"
    Name ="PN"
