...
Begin Form
    ...
    Filter ="([InventoryBadSlackAnalysisIgnoringItemsPreviouslyResolved].[Item] Like \"4518*\""
        ")"
    RecSrcDt = Begin
        0x554c5653b762e440
    End
    RecordSource ="InventoryBadSlackAnalysisIgnoringItemsPreviouslyResolved"
            ...
            Begin
                Begin TextBox
                    ...
                    ConditionalFormat14 = Begin
                        0x0100010000000000000003000000010100000072bc00ffffff00020000002200 ,
                ...
                Begin TextBox
                    ...
                    BorderColor =10921638
                    ForeColor =4210752
                    Name ="Unit Standard Cost"
                    ControlSource ="Unit Standard Cost"
                    EventProcPrefix ="Unit_Standard_Cost"
                    GroupTable =1
                    BottomPadding =150
                    GridlineColor =10921638
                ...
                Begin TextBox
                    ...
                    ControlSource ="Last Activity Date"
                    EventProcPrefix ="Last_Activity_Date"
                    GroupTable =1
                    BottomPadding =150
                    GridlineColor =10921638
...
Private Sub Item_Click()
    DoCmd.OpenForm "IdleInventoryDispositionEntryForm", acNormal, , , , acWindowNormal, Me.Item & "|" & Me.Inventory_Quantity
End Sub
