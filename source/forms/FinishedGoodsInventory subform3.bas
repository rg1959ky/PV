...
Begin Form
    ...
    RecordSource ="SELECT FinishedGoodsInventory.SalesOrderNumber, FinishedGoodsInventory.QtyOfPack"
        ...
        "FinishedGoodsInventory.QtySubTotal, FinishedGoodsInventory.GrossWeight, Finished"
        "GoodsInventory.NetWeight, FinishedGoodsInventory.CBM, FinishedGoodsInventory.Loa"
        "dNumber, FinishedGoodsInventory.CustomerNumber, FinishedGoodsInventory.ShippedFl"
        "ag FROM FinishedGoodsInventory WHERE (((FinishedGoodsInventory.CustomerNumber)=F"
        "orms!DestinationSummaryForm!List0) And ((FinishedGoodsInventory.ShippedFlag)=Fal"
        "se)); "
