        ...
        Begin Section
            ...
            Begin
                ...
                Begin ComboBox
                    ...
                    Width =8040
                    TabIndex =1
                    ColumnInfo ="\"\";\"\";\"Title\";\"\";\"10\";\"100\""
                    Name ="cboParent"
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT tblCabList.PNPartNumber, PN.PNTitle FROM tblCabList INNER JOIN PN ON tblC"
                        "abList.PNPartNumber=PN.PNPartNumber WHERE (((PN.PNTitle) Like '*' & Forms!frmChe"
                        "ckComponentStatus!txtFilter & '*')) ORDER BY tblCabList.PNPartNumber; "
                    ColumnWidths ="1440"
...
Private Sub txtFilter_AfterUpdate()
    ...
    Me.cboParent.RowSource = "SELECT tblCabList.PNPartNumber, PN.PNTitle" & _
                                ...
                                "OR ((PN.PNDetail) Like '*'& Forms![frmCheckComponentStatus]![txtFilter] &'*'))" & _
