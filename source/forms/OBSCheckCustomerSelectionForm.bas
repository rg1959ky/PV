        ...
        Begin Section
            ...
            Begin
                Begin Subform
                    ...
                    Name ="OBSCheckCustomerSelection subform"
                    SourceObject ="Form.OBSCheckCustomerSelection subform"
                    EventProcPrefix ="OBSCheckCustomerSelection_subform"
                ...
                Begin Label
                    ...
                    Name ="Label1"
                    Caption ="OBSOLESCENCE CHECK CUSTOMER SELECTION FORM"
                ...
                Begin Label
                    ...
                    ForeColor =2366701
                    Name ="Label2"
                    Caption ="由以下列表选取所有须查询的客户名称 , 然后按下\"执行废止评估\"."
                    GridlineColor =10921638
                    LayoutCachedTop =420
                ...
                Begin CommandButton
                    ...
                    TabIndex =1
                    ForeColor =4138256
                    Name ="btnPerformOBSCheck"
                    Caption ="Perform OBS Check"
...
Private Sub btnPerformOBSCheck_Click()
    Dim strDoc As String
    If DCount("*", "OBSCheckMissingStandardCosts") > 0 Then
        MsgBox "There are missing standard costs! Use DGSystemCosting to add them first!", vbCritical, "You can't proceed with OBS Check!"
        strDoc = "OBSCheckMissingStandardCosts"
        DoCmd.OpenQuery strDoc, acViewNormal, acReadOnly
        Exit Sub
    End If
