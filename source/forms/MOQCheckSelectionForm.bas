        ...
        Begin Section
            ...
            Begin
                ...
                Begin CommandButton
                    ...
                    ForeColor =4138256
                    Name ="btnCheckOBS"
                    Caption ="Check for Unique Component MOQ's"
                ...
                Begin Label
                    ...
                    ForeColor =2366701
                    Name ="Label22"
                    Caption ="If a customer is launching new products, you can use this form to list unique co"
                        "mponents and the MOQ's, last purchase price, etc. Use caution as initially this "
                        "info may not be correct and should be double checked by the Purchasing Departmen"
                        "t!"
                    GridlineColor =10921638
                    LayoutCachedLeft =120
                    LayoutCachedTop =420
