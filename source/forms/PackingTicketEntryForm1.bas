        ...
        Begin Section
            ...
            Begin
                ...
                Begin Subform
                    ...
                    Begin
                        Begin Label
                            ...
                            Caption ="3. Enter packing ticket information (If the order is highlighted red it has been"
                                " shipped and can not be changed) If you are going to partial ship the order plea"
                                "se split the packing ticket."
                ...
                Begin Label
                    ...
                    BorderColor =8355711
                    Name ="Label14"
                    Caption ="If Packing Ticket quantity exceeds order quantity - check for errors"
                    GridlineColor =10921638
                    LayoutCachedLeft =6000
